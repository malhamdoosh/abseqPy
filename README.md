...
## AbSeq
**AbSeq** is a quality control pipeline for the construction of antibody libraries, currently running on version 1.1.14
...
| `-b, --bitscore`             	| range values (inclusive). If only one value is provided, implicitly starts from the value. Example: `-b 300-inf` is equivalent to `-b 300` [default = 300-inf]  	| **Filtering criterion**  <br /> Filters sequences based on the V-gene bitscore from IgBlast.                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `-ss, --sstart`              	| range values (inclusive). If only one value is provided, implicitly starts from the value. Example: `-ss 1-inf` is equivalent to `-ss 1` [default = 1-3]       	| **Filtering criterion**  <br /> Filters sequences based on the subject's V-gene starting index.                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `-al, --alignlen`            	| range values (inclusive). If only one value is provided, implicitly starts from the value. Example: `-al 300-inf` is equivalent to `-al 300` [default = 250-inf]	| **Filtering criterion**  <br /> Filters sequences based on the sequence alignment length.                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `-t5, --trim5`               	| integer value [default = 0]                                                                                                                                    	| Number of nucleotides to trim on the 5'end of variable region                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `-t3, --trim3`               	| integer value [default = 0]                                                                                                                                    	| Number of nucleotides to trim on the 3'end of variable region                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
Sievers F, Wilm A, Dineen DG, Gibson TJ, Karplus K, Li W, Lopez R, McWilliam H, Remmert M, S�ding J, Thompson JD,
Higgins DG (2011). 
